...
//   useEffect(() => {
//     axios
//       .get('http://localhost:5000/api/purchaseinvoice')
...
//       await axios.post('http://localhost:5000/api/purchaseinvoice', invoiceRefundData);
...
//   useEffect(() => {
//     axios
//       .get('http://localhost:5000/api/supplier')  // Change this to your suppliers API endpoint
//       .then((response) => {
...
//     try {
//       // Post the data to your backend
//       await axios.post('http://localhost:5000/api/purchaseinvoice', invoiceRefundData);  // URL for submitting data
