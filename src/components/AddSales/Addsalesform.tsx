...
const Addsalesform: React.FC = () => {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    const storedSales: FormData[] = JSON.parse(localStorage.getItem('sales') || '[]');
    localStorage.setItem('sales', JSON.stringify([...storedSales, formData]));
  ...
  return (
    <div className="p-8 bg-white rounded-lg shadow-xl max-w-4xl mx-auto mt-10">
      <h1 className="text-3xl font-semibold text-gray-800 mb-8 text-center">Add Sales</h1>
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* Full Name */}
        <div>
          <label className="block text-lg font-medium text-gray-700">Full Name / Business Name *</label>
          <input
            type="text"
            name="fullName"
